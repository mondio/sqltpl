...
/**
 * kj_master_employment_type
 * @author hezhe
 */
public class kj_master_employment_type {
	public static void satrt(String update_per_code,String contract_company_id){
		String childName="kj_master_employment_type";
		String childSeq="nextval('kj_master_employment_type_seq')";
