 ...
 * @author hezhe
 */
public class kj_master_section {
	public static void satrt(Integer seqId,String update_per_code,String contract_company_id){
		String parentName="kj_master_section_group";
		String childName="kj_master_section";
		String parentSeq="nextval('kj_master_section_group_seq')";
		String childSeq="nextval('kj_master_section_seq')";
