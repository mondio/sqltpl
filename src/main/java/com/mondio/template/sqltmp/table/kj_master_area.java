 ...
 * @author hezhe
 */
public class kj_master_area {
	public static void satrt(Integer seqId,String update_per_code,String contract_company_id){
		String parentName="kj_master_area_group";
		String childName="kj_master_area";
		String parentSeq="nextval('kj_master_area_group_seq')";
		String childSeq="nextval('kj_master_area_seq')";
