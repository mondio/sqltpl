 ...
 * @author hezhe
 */
public class kj_master_industry {
	public static void satrt(Integer seqId,String update_per_code,String contract_company_id){
		String parentName="kj_master_industry_group";
		String childName="kj_master_industry";
		String parentSeq="nextval('kj_master_industry_group_seq')";
		String childSeq="nextval('kj_master_industry_seq')";
